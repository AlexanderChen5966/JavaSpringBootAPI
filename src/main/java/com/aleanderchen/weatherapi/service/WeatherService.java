...
//            return new WeatherAllResponse("未知地點", "查無地點", "查無地點", "查無地點");
//        }
//
//        String forecast36hr = cwaApiService.fetch36HourForecast(city).getDescription();
//        String forecast3days = cwaApiService.fetch3DayForecast(city).getDescription();
//        String forecast7days = cwaApiService.fetch7DayForecast(city).getDescription();
//
